#' Variance of the ZPE distribution.
#'
#' Computes the variance of the ZPE distribution for given values of \eqn{\alpha} and \eqn{\beta}.
...
#' @export
#'
zpeVariance <- function(alpha, beta, tolerance = 10^(-4)){
  moment1 <- zpeMoments(1, alpha, beta, tolerance)
  moment2 <- zpeMoments(2, alpha, beta, tolerance)
